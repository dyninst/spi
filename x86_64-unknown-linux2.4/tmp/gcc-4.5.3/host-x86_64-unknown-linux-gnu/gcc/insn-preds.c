...
#line 1050 "../.././gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1076 "../.././gcc/config/i386/predicates.md"
...
#line 1084 "../.././gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  int ret;
...
#line 1199 "../.././gcc/config/i386/predicates.md"
{
  unsigned i, nregs = TARGET_64BIT ? 16 : 8;
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1237 "../.././gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1247 "../.././gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1251 "../.././gcc/config/i386/predicates.md"
...
#line 1258 "../.././gcc/config/i386/predicates.md"
{
