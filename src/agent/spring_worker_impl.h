...
#ifndef _SPRING_WORKER_IMPL_H_
#define _SPRING_WORKER_IMPL_H_

#include "inst_worker_delegate.h"

namespace sp {
  class SpPoint;
	// Generate one-hop springboard
	class SpringboardWorker : public InstWorkerDelegate {
	public:
