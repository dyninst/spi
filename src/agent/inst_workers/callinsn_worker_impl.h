...
#ifndef _CALLINSN_WORKER_IMPL_H_
#define _CALLINSN_WORKER_IMPL_H_
...
namespace sp {
  class SpPoint;
	...
	class RelocCallInsnWorker : public InstWorkerDelegate {
	public:
	  RelocCallInsnWorker() : InstWorkerDelegate() {}
...
#endif /* _CALLINSN_WORKER_IMPL_H_ */
