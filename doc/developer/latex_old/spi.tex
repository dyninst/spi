...
% have to specify positions manually
        ...
        ] at ($(origin)+(0.75in,-3.0in)$)
    {
        ...
        \fontsize{36}{48}\selectfont Developer's Manual \\
    };
...
\input{section/2_abstraction}
\input{section/3_how_it_works}
\input{section/4_examples}
\input{section/5_class}
\input{section/6_internal}

\appendix
\input{section/a_install}
\input{section/b_testing}
\input{section/c_dir}
